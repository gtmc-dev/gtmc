...
const allItems: any[] = [];
  ...
  function sortTree(nodes: TreeNode[]) {
    ...
    nodes.sort((a, b) => {
      ...
      const aIsAppendixDir = a.isFolder && isAppendixDirectoryName(a.title)
      const bIsAppendixDir = b.isFolder && isAppendixDirectoryName(b.title)
      if (aIsAppendixDir !== bIsAppendixDir) {
        return aIsAppendixDir ? 1 : -1
      }
