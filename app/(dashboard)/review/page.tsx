      ...
      <div className="grid grid-cols-1 gap-6">
        {pendingRevisions.length === 0 ? (
          <div className="py-16 text-center border border-dashed border-tech-main/40 bg-white/30 backdrop-blur-sm relative group">
            ...
            <h2 className="text-xl font-mono text-tech-main/50 tracking-widest uppercase relative z-10">
            ...
            >
              ...
              <div className="flex-1 relative z-10">
                <div className="flex items-center gap-3 mb-3">
                  <span className="bg-blue-500/10 text-blue-600 px-2 py-0.5 text-[10px] font-mono border border-blue-500/40 tracking-wider">
                    [PENDING]
                  </span>
                ...
                <p className="text-tech-main/80 font-mono text-xs mb-3 pl-3">
                  Submitted by:{" "}
                  <span className="text-tech-main-dark font-semibold">
